...
CREATE SCHEMA IF NOT EXISTS dcsa_ovs_v1_0;
GRANT ALL PRIVILEGES ON DATABASE dcsa_openapi TO dcsa_db_owner;
GRANT ALL PRIVILEGES ON SCHEMA dcsa_ovs_v1_0 TO dcsa_db_owner;
ALTER DEFAULT PRIVILEGES IN SCHEMA dcsa_ovs_v1_0 GRANT ALL ON TABLES TO dcsa_db_owner;
