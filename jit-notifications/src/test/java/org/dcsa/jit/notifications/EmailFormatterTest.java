...
public class EmailFormatterTest {
  ...
  public void testAllValuesSubstituted() {
    ...
    mailTemplate.setBody("Stuff {{WEB_UI_BASE_URI}} Stuff {{PORT_VISIT_ID}} Stuff {{TIMESTAMP_TYPE}} Stuff {{VESSEL_IMO_NUMBER}} Stuff");
    ...
    assertEquals("Stuff WebUIBaseUrl Stuff 5db49152-a0d3-41c6-af1d-219c0eb7abcd Stuff ETA-Berth Stuff 1234567 Stuff", formattedEmail.body());
  }
